  ...
  return (
    <div className="">
      ...
      <div className="lg:grid lg:grid-cols-3">
        ...
        <div className="grid lg:grid-cols-2 py-10 col-span-2 ">
          <div className="bg-red-50">
            ...
            <p className="bg-red-50 p-2 px-[5%]">
              ...
              <br />
              CHRISTMAS Eve Dinner @ 1750 net / child applicable on 24th Dec
              2023 <br />
              NEW YEAR Gala Dinner @ 3500 net / head applicable on 31st Dec 2023{" "}
              <br />
              NEW YEAR Gala Dinner @ 2000 Net / child applicable on 31th Dec
              2023 <br /> <br />
              <p>
                ...
                <br />
                Cancellation within 3 days or before of arrival date, 20% will
                be deducted <br />
          ...
          <div className=" grid lg:grid-rows-2">
            ...
            <div className="bg-yellow-50 p-2 px-[5%]">
              ...
              /Voters ID / Driving License / Passport ) of all adult guest at
              the time of check in. Pan card not acceptable. <br />
              ...
              • Full and final payments to be made three bank working days
              before the date of Tour for FIT & GIT bookings. <br />
              • Check-out time will be 11:00 AM. Check-in time will be at 02:00
              PM Noon. <br />
